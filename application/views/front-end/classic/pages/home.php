<section class="mt-2">
    <div class="main-content">
        <div class=''>
            ...
            <div class="swiper-container banner-swiper slider-img-swiper">
...
<section class="main-content mt-md-2 mt-sm-0 ">
    <?php if (isset($categories) && !empty($categories) && $categories != []) { ?>
        <div class="category-section container-fluid text-center category-section icon-dark-sec ">
            ...
            <!-- Swiper -->
            <div
                class="swiper-container category-swiper swiper-container-initialized swiper-container-horizontal icon-swiper">
                ...
                <!-- Add Pagination -->
                <div class="swiper-pagination category-swiper-pagination swiper-pagination-bullets"><span
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <h3 class="section-title">
                                <?= !empty($this->lang->line('brands')) ? $this->lang->line('brands') : 'Brands' ?>
                            </h3>
                        </div>
                        <div class="col-12 text-right"><a href="<?= base_url('home/brands/') ?>"
                                class="featured-section-view-more"><?= !empty($this->lang->line('see_all')) ? $this->lang->line('see_all') : 'See All' ?></a>
                        </div>
                    </div>
                    <hr>
                </div>
                                ...
                                <div class="categories-card">
                                    <a href="<?= base_url('products?brand=' . html_escape($row['brand_slug'])) ?>"
                                        ...
                                        <div class="brands-image">
                                            <img src="<?= !empty($row['brand_img']) ? base_url($row['brand_img']) : base_url(NO_IMAGE) ?>"
                        ...
                        <div class="my-4 featured-section-title">
                            <div class="row">
                                ...
                                <div class="col-12 text-right"><a
                                        href="<?= base_url('products/section/' . $row['id'] . '/' . $row['slug']) ?>"
                                        class="featured-section-view-more"><?= !empty($this->lang->line('view_more')) ? $this->lang->line('view_more') : 'View More' ?></a>
                                </div>
                            </div>
                            <hr>
                        </div>
                            ...
                            <?php foreach ($row['product_details'] as $product_row) {
                                ...
                                <div class="swiper-slide">
                                    <div class="product-grid">
                                        <aside class="add-fav">
                                            <button type="button"
                                                class="btn <?= ($product_row['is_favorite'] == 1) ? '' : 'far' ?> fa-heart add-to-fav-btn <?= ($product_row['is_favorite'] == 1) ? 'fa text-danger' : '' ?>"
                                                data-product-id="<?= $product_row['id'] ?>"></button>
                                        </aside>
                                        <div class="product-image">
                                            ...
                                            <ul class="social">
                                                ...
                                                <li>
                                                    ...
                                                    <a href="#" data-tip="Add to Cart" class="add_to_cart"
                                                        ...
                                                        data-step="<?= $data_step; ?>" data-max="<?= $data_max; ?>"
                                            ...
                                            <?php if (isset($product_row['min_max_price']['special_price']) && $product_row['min_max_price']['special_price'] != '' && $product_row['min_max_price']['special_price'] != 0 && $product_row['min_max_price']['special_price'] < $product_row['min_max_price']['min_price']) { ?>
                                                ...
                                                <?php } else { ?>
                                                    <span
                                                        class="product-discount-label"><?= $product_row['min_max_price']['discount_in_percentage'] ?>%</span>
                                                <?php } ?>
                                        ...
                                        <div itemscope itemtype="https://schema.org/Product">
                                            <?php if (isset($product_row['rating']) && isset($product_row['no_of_rating']) && !empty($product_row['no_of_rating']) && !empty($product_row['rating']) && $product_row['no_of_rating'] != "") { ?>
                                                <div class="col-md-12 mb-3 product-rating-small" dir="ltr" itemprop="aggregateRating"
                                                    itemscope itemtype="https://schema.org/AggregateRating">
                                                    <meta itemprop="reviewCount" content="<?= $product_row['no_of_rating'] ?>" />
                                                    <meta itemprop="ratingValue" content="<?= $product_row['rating'] ?>" />
                                                    <input type="text" class="kv-fa rating-loading" value="<?= $product_row['rating'] ?>"
                                            ...
                                            <div class="product-content">
                                                <h2 class="title"
                                                    ...
                                                    itemprop="name">
                                                    <a
                                                        href="<?= base_url('products/details/' . $product_row['slug']) ?>"><?= word_limit(output_escaping(str_replace('\r\n', '&#13;&#10;', $product_row['name']))) ?></a>
                                                </h2>
                                                ...
                                                $data_step = (isset($product_row['minimum_order_quantity']) && !empty($product_row['quantity_step_size'])) ? $product_row['quantity_step_size'] : 1;
                                                $data_max = (isset($product_row['total_allowed_quantity']) && !empty($product_row['total_allowed_quantity'])) ? $product_row['total_allowed_quantity'] : 0;
                                                $variant_values = isset($product_row['variants'][0]['variant_values']) ? $product_row['variants'][0]['variant_values'] : '';
                                                ?>
                                                <a href="#" class="add-to-cart add_to_cart" data-product-id="<?= $product_row['id'] ?>"
                                                    data-product-variant-id="<?= $variant_id ?>"
                                                    data-variant-values="<?= htmlspecialchars($variant_values) ?>"
                                                    data-product-title="<?= $product_row['name'] ?>"
                                                    data-product-image="<?= $product_row['image'] ?>"
                                                    data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>"
                                                    data-step="<?= $data_step; ?>" data-max="<?= $data_max; ?>"
                    ...
                    <div class="product-style-1 product-style-1-right product-section pt-4 pb-4 bg-white mt-2 mb-2 row ">
                        ...
                        <?php foreach ($row['product_details'] as $key => $product_row) {
                            ...
                            <?php if ($key != $product_count) { ?>
                                    <div class="col-md-4 col-6">
                                        <div class="product-grid">
                                            <aside class="add-fav"> <button type="button"
                                                    class="btn <?= ($product_row['is_favorite'] == 1) ? '' : 'far' ?> fa-heart add-to-fav-btn <?= ($product_row['is_favorite'] == 1) ? 'fa text-danger' : '' ?>"
                                                    data-product-id="<?= $product_row['id'] ?>"></button>
                                            </aside>
                                            <div class="product-image">
                                            ...
                                            <div itemscope itemtype="https://schema.org/Product">
                                            <?php if (isset($product_row['rating']) && isset($product_row['no_of_rating']) && !empty($product_row['no_of_rating']) && !empty($product_row['rating']) && $product_row['no_of_rating'] != "") { ?>
                                                    <div class="col-md-12 mb-3 product-rating-small" dir="ltr" itemprop="aggregateRating" itemscope
                                            ...
                                            <?php } ?>
                                                <div class="product-content">
                                                    ...
                                                    <?php if ($product_row['is_on_sale'] == 1) { ?>
                                                            <meta itemprop="price"
                                                                content="<?= $product_row['variants'][0]['sale_final_price']; ?>" />
                                                    <?php } else { ?>
                                                            <meta itemprop="price" content="<?= $product_row['variants'][0]['price']; ?>" />
                                                    <?php } ?>
                        ...
                        <div class="col-md-4 col-12 style-3-product-right-lg">
                            <div class="product-grid">
                                <aside class="add-fav"> <button type="button"
                                        class="btn <?= ($product_row['is_favorite'] == 1) ? '' : 'far' ?> fa-heart add-to-fav-btn <?= ($product_row['is_favorite'] == 1) ? 'fa text-danger' : '' ?>"
                                        data-product-id=<?= $last_product['id'] ?>></button>
                                </aside>
                                <div class="product-image">
                                ...
                                <div class="col-md-12 mb-3 product-rating-small" dir="ltr">
                                    <input type="text" class="kv-fa rating-loading" value="<?= $last_product['rating'] ?>"
                                        data-size="sm" title="" readonly>
                                </div>
                                <div class="product-content">
                                    <h2 class="title"
                                        title="<?= output_escaping(str_replace('\r\n', '&#13;&#10;', ($last_product['name']))) ?>">
                                        <a
                                            href="<?= base_url('products/details/' . $last_product['slug']) ?>"><?= output_escaping(str_replace('\r\n', '&#13;&#10;', word_limit($last_product['name']))) ?></a>
                                    </h2>
                                    <div class="mb-1">
                                    <?php if (($product_row['variants'][0]['special_price'] < $product_row['variants'][0]['price']) && ($product_row['variants'][0]['special_price'] != 0)) { ?>
                                            <p class="mb-2 mt-2">
                                ...
                                $variant_values = isset($product_row['variants'][0]['variant_values']) ? $product_row['variants'][0]['variant_values'] : '';
                                ?>
                                    <a href="#" class="add-to-cart add_to_cart" data-product-id="<?= $last_product['id'] ?>"
                                        data-product-variant-id="<?= $variant_id ?>"
                                        data-variant-values="<?= htmlspecialchars($variant_values) ?>"
                                        data-product-title="<?= $product_row['name'] ?>"
                                        data-product-image="<?= $product_row['image'] ?>" data-product-price="<?= $variant_price; ?>"
                                        data-min="<?= $data_min; ?>" data-step="<?= $data_step; ?>" data-max="<?= $data_max; ?>"
                                        data-product-description="<?= $product_row['short_description']; ?>"
                                        data-izimodal-open="<?= $modal ?>"><i class="fas fa-cart-plus"></i>
                                    <?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></a>
                                </div>
                        ...
                        <div class="product-style-1 product-style-1-left product-section pt-4 pb-4 bg-white mt-2 mb-2 row">
                            <div class="col-md-4 col-12 style-3-product-right-lg">
                                <div class="product-grid">
                                    <aside class="add-fav">
                                        <button type="button"
                                            class="btn <?= ($first_product['is_favorite'] == 1) ? '' : 'far' ?> fa-heart add-to-fav-btn <?= ($first_product['is_favorite'] == 1) ? 'fa text-danger' : '' ?>"
                            ...
                            <?php } ?>
                                    <div class="product-image">
                                        ...
                                        ?>
                                                <a href="#" data-tip="Add to Cart" class="add_to_cart"
                                                    ...
                                                    data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>"
                                                    data-step="<?= $data_step; ?>" data-max="<?= $data_max; ?>"
                                                    data-product-description="<?= $first_product['short_description']; ?>"
                                                    data-izimodal-open="<?= $modal ?>">
                                                    <i class="fa fa-shopping-cart"></i>
                                                </a>
                                            </li>
                                ...
                                <?php } else { ?>
                                            <div class="col-md-12 mb-3 product-rating-small" dir="ltr">
                                                <input type="text" class="kv-fa rating-loading" value="<?= $first_product['rating'] ?>"
                                                    data-size="sm" title="" readonly>
                                            </div>
                                <?php } ?>
                                        <div class="product-content">
                                            <h2 class="title"
                                                ...
                                                itemprop="name">
                                                <a
                                                    href="<?= base_url('products/details/' . $first_product['slug']) ?>"><?= output_escaping(str_replace('\r\n', '&#13;&#10;', word_limit($first_product['name']))) ?></a>
                                            </h2>
                                            <div itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                                    ...
                                    $data_step = (isset($first_product['minimum_order_quantity']) && !empty($first_product['quantity_step_size'])) ? $first_product['quantity_step_size'] : 1;
                                    $data_max = (isset($first_product['total_allowed_quantity']) && !empty($first_product['total_allowed_quantity'])) ? $first_product['total_allowed_quantity'] : 0;
                                    $variant_values = isset($first_product['variants'][0]['variant_values']) ? $first_product['variants'][0]['variant_values'] : '';
                                    ?>
                                            <a href="#" class="add-to-cart add_to_cart" data-product-id="<?= $first_product['id'] ?>"
                                                data-product-variant-id="<?= $variant_id ?>"
                                                data-variant-values="<?= htmlspecialchars($variant_values) ?>"
                                                data-product-title="<?= $first_product['name'] ?>"
                                                data-product-image="<?= $first_product['image'] ?>"
                            ...
                            <?php if ($key != 0) { ?>
                                        <div class="col-md-4 col-6">
                                            <div class="product-grid">
                                                <aside class="add-fav">
                                                    <button type="button"
                                                        class="btn far fa-heart add-to-fav-btn <?= ($product_row['is_favorite'] == 1) ? 'fa text-danger' : '' ?>"
                                                        data-product-id="<?= $product_row['id'] ?>"></button>
                                                </aside>
                                                <div class="product-image">
                                                    <div class="product-image-container">
                                            ...
                                            <?php } ?>
                                                ...
                                                <div class="product-content">
                                                    <h2 class="title"
                                                        title="<?= output_escaping(str_replace('\r\n', '&#13;&#10;', ($product_row['name']))) ?>">
                                                        <a
                                                            href="<?= base_url('products/details/' . $product_row['slug']) ?>"><?= output_escaping(str_replace('\r\n', '&#13;&#10;', word_limit($product_row['name']))) ?></a>
                                                    </h2>
                                                    <div class="mb-1">
                                                <?php if (($product_row['variants'][0]['special_price'] < $product_row['variants'][0]['price']) && ($product_row['variants'][0]['special_price'] != 0)) { ?>
                                                            <p class="mb-2 mt-2">
                        ...
                        <?php } ?>
                                    <div class="col-md-2 col-6">
                                        <div class="product-grid h-100">
                                            <div class="product-image featured-section h-100">
                                                <div
                                                    class="product-image-container h-100 d-flex align-items-center justify-content-center overflow-hidden">

                                                    <!-- If you have an image -->
                                                    <img src="<?= !empty($row['image']) ? base_url($row['image']) : base_url(NO_IMAGE) ?>"
                                                        class="img-fluid w-100 h-100 object-fit-cover" alt="<?= html_escape($row['title']) ?>"
                                                        onerror="this.onerror=null;this.src='<?= base_url(NO_IMAGE) ?>';">

                                                    <!-- Content overlay -->
                                                    <div class="featured-section-title position-absolute text-white w-100">
                                                        <div class="col-md-12 text-left">
                                                            <h3 class="section-title"><?= ucfirst($row['title']) ?></h3>
                                                            <div class="title-sm"><?= strip_tags($row['short_description']) ?></div>
                                                            <div class="col-12">
                                                                <a href="<?= base_url('products/section/' . $row['id'] . '/' . $row['slug']) ?>"
                                                                    class="featured-section-view-more">
                                                        <?= !empty($this->lang->line('view_more')) ? $this->lang->line('view_more') : 'View More' ?>
                                                                </a>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="text-area">
                        ...
                        <div class="mt-3">
                            <a href="<?= $web_settings['app_download_section_appstore_url'] ?>" target="_blank"><img
                                    src="<?= THEME_ASSETS_URL . 'demo/app-store/app-store.png' ?>" alt=""
                                    class="download_section" width="150"></a>
                            <a href="<?= $web_settings['app_download_section_playstore_url'] ?>" target="_blank"><img
                                    src="<?= THEME_ASSETS_URL . 'demo/app-store/google-play-store.png' ?>" alt=""
                                    class="download_section" width="150"></a>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="icon-box-wrapper">
                                    <div class="info-box-icon">
                                        <div class="svg-wrapper">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="40pt"
                                                viewBox="1 -104 511.99975 511" width="100pt">
                                                <path class="cls-1"
                        ...
                        <div class="info-box-wrapper inline-element">
                            <div class="box-icon info-box custom light-color">
                                <div class="icon-box-wrapper">
                                    <div class="info-box-icon">
                                        <div class="svg-wrapper">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="40pt" viewBox="0 0 512 512"
                                                width="100pt">
                                                <path class="cls-1"
                            ...
                            <div class="box-icon info-box custom light-color">
                                <div class="icon-box-wrapper">
                                    <div class="info-box-icon">
                                        <div class="svg-wrapper">
                                            <svg xmlns="http://www.w3.org/2000/svg" height="40pt"
                                                viewBox="-21 -21 682.66669 682.66669" width="100pt">
                                                <path class="cls-1"
                        ...
                        <div class="info-box-wrapper inline-element">
                            <div class="box-icon info-box custom light-color">
                                <div class="icon-box-wrapper">
                                    <div class="info-box-icon">
                                        <div class="svg-wrapper">
                                            <svg width="100pt" viewBox="-38 0 512 512.00142" version="1.1" height="40pt"
    ...
    <div class="modal fade" id="offer_popup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content modal-transparent bg-transparent border-color-transparent">
                ...
                <div class="modal-body modal_border_none cursor-pointer pt-0"
                    onclick="location.href='<?= base_url('products/manage_popup_offers/' . $id) ?>'">

                    <img class="w-100 d-block" onerror="this.src='<?= base_url($image) ?>'" src="<?= base_url($image) ?>"
                        alt="">
                </div>
