                    ...
                    <form action="<?= base_url('my-account/add-address') ?>" method="POST" id="add-address-form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group city">
                                <label for="city"
                                    class="control-label"><?= !empty($this->lang->line('city')) ? $this->lang->line('city') : 'City' ?></label>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 form-group area_name d-none">
                                ...
                                <input type="text" class="form-control " id="area_name" name="area_name"
                                    placeholder="<?= !empty($this->lang->line('area_name')) ? $this->lang->line('area_name') : 'Area Name' ?>" />
                            </div>
                        ...
                        <table id="address_list_table" class="table-striped" data-toggle="table"
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th data-field="action" data-events="editAddress" data-sortable="false">
