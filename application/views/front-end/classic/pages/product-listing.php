                                ...
                                ?>
                                    <div class="brand_div me-1">
                                        <label class="form-check-label" for="<?= $value['brand_id'] ?>-brand">
                                          ...
                                          <img src="<?= !empty($value['brand_img']) ? base_url($value['brand_img']) : base_url(NO_IMAGE) ?>"
                                            alt="brand-logo"
                                            ...
                                            <div class="col-md-9">
                                                <div class="product-content">
                                                    ...
                                                    <div class="price mb-2 list-view-price" itemprop="offers" itemscope itemtype="https://schema.org/Offer">
                                                        ...
                                                        <?php
                                                        $price_to_show = ($row['is_on_sale'] == 1 && $row['variants'][0]['sale_final_price'] > 0 && $row['variants'][0]['sale_final_price'] != '') ? $row['variants'][0]['sale_final_price'] : ($row['variants'][0]['special_price'] > 0 && $row['variants'][0]['special_price'] != '' ? $row['variants'][0]['special_price'] : $row['variants'][0]['price']);
                                                        ?>
                                                        <span itemprop="price"><?= $settings['currency'] ?><?= number_format($price_to_show, 2) ?></span>
                                                        <?php if (isset($row['min_max_price']['special_price']) && $row['min_max_price']['special_price'] != '' && $row['min_max_price']['special_price'] != 0 && $row['min_max_price']['special_price'] < $row['min_max_price']['min_price']) { ?>
                                                            <span class="striped-price"><?= $settings['currency'] ?><?= number_format($row['min_max_price']['min_price'], 2) ?></span>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="button button-sm m-0 p-0">
                                                        ...
                                                        $data_step = (isset($row['quantity_step_size']) && !empty($row['quantity_step_size'])) ? $row['quantity_step_size'] : 1;
                                                        $data_max = (isset($row['total_allowed_quantity']) && !empty($row['total_allowed_quantity'])) ? $row['total_allowed_quantity'] : 0;
                                                        $variant_values = isset($row['variants'][0]['variant_values']) ? $row['variants'][0]['variant_values'] : '';
                                                        ?>
                                                        <?php if ($row['variants'][0]['cart_count'] != 0) { ?>
                                                        ...
                                                        <?php } else { ?>
                                                            <a class="add-to-cart add_to_cart" href="" data-product-id="<?= $row['id'] ?>" data-product-variant-id="<?= $variant_id ?>" data-variant-values="<?= htmlspecialchars($variant_values) ?>" data-product-title="<?= $row['name'] ?>" data-product-image="<?= $row['image'] ?>" data-product-price="<?= $variant_price; ?>" data-min="<?= $data_min; ?>" data-max="<?= $data_max; ?>" data-step="<?= $data_step; ?>" data-product-description="<?= $row['short_description']; ?>" data-izimodal-open="<?= $modal ?>">+ <?= !empty($this->lang->line('add_to_cart')) ? $this->lang->line('add_to_cart') : 'Add To Cart' ?></a>
                                                        <?php } ?>
                                                    </div>
                                                </div>
                                            </div>
                                                            ...
                                                            <?php if (isset($row['min_max_price']['special_price']) && $row['min_max_price']['special_price'] != '' && $row['min_max_price']['special_price'] != 0 && $row['min_max_price']['special_price'] < $row['min_max_price']['min_price']) { ?>
                                                                <sup>
                                                                    <span class="special-price striped-price text-danger" id="product-striped-price-div">
                                                                        <s id="striped-price">
                                                                            <?= $settings['currency'] ?><?= number_format($row['min_max_price']['min_price'], 2) ?>
                                                                        </s>
                                                                    </span>
                                                                </sup>
                                                            <?php } ?>
                                            ...
                                            <div class="card-body-custom">
                                                ...
                                                ?>
                                                    <div class="input-container d-flex">
                                                        ...
                                                        <label class="toggle checkbox" for="<?= 'm' . $row_attr_name . ' ' . $values ?>">
                                                            <div class="toggle-inner"></div>
                                                        </label>
