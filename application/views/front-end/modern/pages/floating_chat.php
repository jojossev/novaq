...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url('assets/front_end/modern/fontawesome-free-6.4.0-web/css/all.css') ?>">
    <link rel="stylesheet" href="<?= base_url('assets/front_end/modern/css/select2.min.css') ?>">
    <script defer src="<?= base_url("assets/front_end/modern/js/select2.full.min.js") ?>"></script>
...
<body>
    <section class="my-account-section">
        <div class="container mt-2">
            <div class="fs-5 fw-bold m-1">Chat</div>
            <div id="floating_chat_view" class="h-100 mt-0">
                <div class="row h-100">
                    <div class="col-sm-2 floating-chat-users">
                        <div class="chat-theme-light chat-scroll chat-min">
                            <select name="select_user_id[]" id="chat_user_main" class="search_user w-100 mt-2" data-placeholder="Search for support team">
                    ...
                    <div class="col-12 col-sm-8 col-lg-9 d-none" id="chat_area_wait"></div>
