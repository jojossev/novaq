<div class="content-wrapper">
    ...
    <section class="content-header mt-4">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h4>Gérer les produits FAQs</h4>
                </div>
                <div class="col-sm-4 d-flex justify-content-end">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/home') ?>">Accueil</a></li>
                        <li class="breadcrumb-item active">FAQ des produits</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/product_faqs/add_faqs'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <button type="submit" class="btn btn-success update_faqs" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Mettre à jour Product Faq' : 'Ajouter un produit FAQ' ?></button>
                                </div>
                            ...
                            "ignoreColumn": ["state"] 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="user_id" data-sortable="false" data-visible='false'>ID utilisateur</th>
                                        ...
                                        <th data-field="answered_by_name" data-sortable="false">Answered by</th>
                                        <th data-field="username" data-width='500' data-sortable="false" class="col-md-6">Nom d'utilisateur</th>
