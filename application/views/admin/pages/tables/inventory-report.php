<div class="content-wrapper">
    ...
    <section class="content-header mt-4">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-md-8">
                    <h4>View Rapport d'inventaire</h4>
                </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="inventory_datepicker" class="form-label">Plage de dates:</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="inventory_datepicker" placeholder="Sélectionnez une plage de dates pour filtrer" autocomplete="off">
            ...
            <div class="row mb-3">
                    ...
                    <div class="card">
                        <div class="card-header text-white">
                            <h5 class="card-title mb-0">
                                <i class="fas fa-chart-pie"></i> Top Produits by Sales
                            </h5>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header text-white">
                            <h5 class="card-title mb-0">
                                <i class="fas fa-chart-donut"></i> Top Produits by Units Sold
                            </h5>
                        </div>
                        <div class="card-body">
