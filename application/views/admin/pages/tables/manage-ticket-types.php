<div class="content-wrapper">
    ...
    <section class="content-header mt-4">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-8">
                    <h4>Gérer Types de tickets</h4>
                </div>
                <div class="col-sm-4 d-flex justify-content-end">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="<?= base_url('admin/home') ?>">Accueil</a></li>
                        <li class="breadcrumb-item active">Types de tickets</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLongTitre">Modifier Type de ticket Value</h5>
                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/tickets/add_ticket_type'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="title" placeholder="Titre" name="title" value="<?= @$fetched_data[0]['title'] ?>">
                                    </div>
                                </div>
                                <div class="form-group mt-3">
                                    <button type="reset" class="btn btn-warning">Réinitialiser</button>
                                    <button type="submit" class="btn btn-success" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Mettre à jour Type de ticket' : 'Ajouter Type de ticket' ?></button>
                                </div>
                            </div>
                ...
                <div class="col-md-7">
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            <div class="card-head">
                                <h4 class="card-title">Types de tickets</h4>
                            </div>
                        ...
                        "ignoreColumn": ["state"] 
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="date_created" data-sortable="true" data-visible="false">Statut</th>
