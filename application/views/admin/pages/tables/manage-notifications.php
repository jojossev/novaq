                ...
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        <form class="form-horizontal form-submit-event"
                            ...
                            <input type="hidden" id="start_date" name="start_time"
                                value="<?= isset($flash_sales[0]['start_date']) ? $flash_sales[0]['start_date'] : ''; ?>">
                            <input type="hidden" id="end_date" name="end_time"
                                value="<?= isset($flash_sales[0]['end_date']) ? $flash_sales[0]['end_date'] : ''; ?>">
                            ...
                            <div class="card-body">
                                        ...
                                        <select name="select_user_id[]" class="search_user w-100" multiple
                                            ...
                                            if (isset($fetched_data[0]['id']) && $fetched_data[0]['type'] == 'users') {
                                                ...
                                                if (!empty($user_details)) {
                                                    ?>
                                                    <option value="<?= $user_details[0]['id'] ?>" selected>
                                                        <?= $user_details[0]['name']; ?></option>
                                                    <?php
                                                }
                                            }
                                            ?>
                                ...
                                <div class="form-group">
                                    <label for="type" class="control-label mt-2">Type <span
                                            class='text-danger text-sm'>*</span></label>
                                    <div class="col-md-12 mt-2">
                                ...
                                <div id="type_add_html">
                                    ...
                                    <div class="form-group notification-url <?= $hiddenStatut ?> ">
                                        ...
                                        <label for="notification_url" class="mt-2"> Link <span
                                                class='text-danger text-sm'>*</span></label>
                                        <input type="url" class="form-control mt-2" placeholder="https://example.com"
                                            name="link" id="link"
                                ...
                                <div class="form-group">
                                    <label for="message" class="control-label mt-2">Message <span
                                            class='text-danger text-sm'>*</span></label>
                                    <div class="col-md-12 mt-2">
                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-innr">
                            ...
                            <table class='table-striped' data-toggle="table"
                                ...
                                data-export-types='["txt","excel"]' data-query-params="SendNotificationQueryParams">
                                <thead>
                                    <tr>
