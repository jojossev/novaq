                    ...
                    <div class="card content-area p-4">
                        ...
                        <div class="card-header border-0">
                            <div class="card-tools">
                                <a href="<?= base_url() . 'admin/category/create-category' ?>" class="btn btn-block  btn-outline-primary btn-sm">Ajouter Catégorie</a>
                            </div>
                        </div>
