                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/delivery_boys/add_delivery_boy'); ?>" method="POST" id="add_product_form">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="name" placeholder="Nom du livreur" name="name" value="<?= @$fetched_data[0]['username'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row mt-1">
                                    <label for="mobile" class="col-sm-2 col-form-label">Mobile <span class='text-danger text-sm'>*</span></label>
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" id="mobile" placeholder="Entrez le mobile" maxlength="16" oninput="validateN°|NuméroInput(this)" name="mobile" value="<?= @$fetched_data[0]['mobile'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row mt-1">
                                ...
                                <div class="form-group row mt-1">
                                    ...
                                    ?>
                                    <label for="bonus_type" class="col-sm-2 control-label">Types de bonus <span class='text-danger text-sm'> * </span></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group row mt-1 fixed_amount_per_order <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['bonus_type'] == 'fixed_amount_per_order') ? '' : 'd-none' ?>">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" min='1' class="form-control" id="bonus_amount" placeholder="Montant donné au livreur par commande livrée" name="bonus_amount" value="<?= @$fetched_data[0]['bonus'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row mt-1 percentage_per_order <?= (isset($fetched_data[0]['id'])  && $fetched_data[0]['bonus_type'] == 'percentage_per_order') ? '' : 'd-none' ?>">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="number" class="form-control" id="bonus_percentage" placeholder="Bonus(%) donné au livreur par commande livrée" name="bonus_percentage" value="<?= @$fetched_data[0]['bonus'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row mb-1">
                                    <label for="driving_license" class="col-sm-2 col-form-label">Permis de conduire <span class='text-danger text-sm'>*</span></label>
                                    <div class="col-sm-10">
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <button type="submit" class="btn btn-success" id="submit_btn"><?= (isset($fetched_data[0]['id'])) ? 'Mettre à jour Livreur' : 'Ajouter un livreur' ?></button>
                                </div>
                            </div>
