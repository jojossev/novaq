                ...
                <div class="col-md-12">
                    <div class="alert alert-info">
                        <ul>
                            ...
                            <li>For adding bulk location file should be .csv format</li>
                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/area/process_bulk_upload'); ?>" method="POST" id="location_bulk_upload_form">
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="card-body pad">
                                        <div class="row">
                                            <div class="form-group zipcode_samples col-md-12 mt-3">
                                        ...
                                        <div class="row">
                                            <div class="form-group area_samples mt-3">
                                                <a href="<?= base_url('uploads/areas-bulk-upload-sample.csv') ?>" class="btn btn-info col-sm-3 m-2" download="areas-bulk-upload-sample.csv">Area Bulk upload sample file <i class="fas fa-download"></i></a>
                                                <a href="<?= base_url('uploads/areas-bulk-update-sample.csv') ?>" class="btn btn-info col-sm-3 m-2" download="areas-bulk-update-sample.csv">Area Bulk update sample file <i class="fas fa-download"></i></a>
                                                <a href="<?= base_url('uploads/cities-bulk-upload-sample.csv') ?>" class="btn btn-info col-md-3 m-2" download="cities-bulk-upload-sample.csv">Cities Bulk upload sample file <i class="fas fa-download"></i></a>
                                                <a href="<?= base_url('uploads/cities-bulk-update-sample.csv') ?>" class="btn btn-info m-2" download="cities-bulk-update-sample.csv">Cities Bulk update sample file <i class="fas fa-download"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
