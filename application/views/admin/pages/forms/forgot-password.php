            ...
            <div class="authentication-inner row">
                ...
                <div class="d-flex col-12 col-sm-5 col-md-4 align-items-center authentication-bg p-sm-5 login-background-color">
                    <div class="card-body login-card-body">
                       ...
                       <p class="login-box-msg"> <span class="fw-bold fs-4">You Forgot Your Mot de passe?</span> <br> <SPAN class="fw-bold"> Here you can easily retrieve a new password.</p> </SPAN>
                        ...
                        <input type="hidden" name="csrf_token" value="$csrf_token()"/>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary btn-block col-md-12" id="submit_btn">Send E-mail</button>
                                </div>
