<div class="content-wrapper">
    ...
    <section class="content-header mt-4">
        ...
        <div class="container-fluid">
            <div class="row">
                <form class="form-horizontal" action="<?= base_url('admin/product/add_product'); ?>" method="POST"
                    ...
                    <div class="col-md-12">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-md-6">
                                                        <label for="pro_input_text"
                                                            class="col-form-label ml-2">Identification of
                                                            Product</label>
                                                        <div class="">
                                                        ...
                                                        <select class=" col-md-12  form-control brand_list"
                                                            ...
                                                            if (isset($product_details[0]['brand']) && $product_details[0]['brand'] != '') {
                                                                ...
                                                                <option value="<?= $product_details[0]['brand'] ?>"
                                                                    <?= (isset($product_details[0]['brand']) && $product_details[0]['brand'] == $brands[0]['name']) ? 'selected' : ''; ?>><?= $product_details[0]['brand'] ?>
                                                                </option>
                                                            <?php } ?>
                                                            <!-- brands display here  -->
                                                        </select>
                                                    ...
                                                    <div class="form-group col-md-6 mt-3">
                                                        <label for="tags">Tags <small>( These tags help you in search
                                                                result )</small></label>
                                                    ...
                                                    <div class="form-group col-md-12 mt-1">
                                                        <label for="short_description" class="col-form-label">
                                                            ...
                                                            <!-- AI Buttons -->
                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-primary ms-2 generate-ai-btn"
                                                                data-field="short_description" title="Generate with AI">
                                                                <i class="bi bi-magic"></i> AI
                                                            </button>

                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-primary ms-1 toggle-custom-prompt-btn"
                                                                data-target="custom-prompt-short_description"
                                                                title="Custom Prompt">
                                                        ...
                                                        <!-- Custom Prompt Box -->
                                                        <div id="custom-prompt-short_description" class="mb-2 d-none">
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    id="prompt-input-short_description"
                                                                    placeholder="Enter custom instructions for AI...">

                                                                <button type="button"
                                                                    class="btn btn-outline-secondary suggest-prompts-btn"
                                                                    data-field="short_description"
                                                                    title="Get Suggested Prompts">
                                                                    <ion-icon name="bulb-outline"
                                                                        class="text-secondary"></ion-icon>
                                                                </button>
                                                            </div>

                                                            <select class="form-select mt-1 d-none prompt-suggestions"
                                                                id="suggestions-short_description"
                                                                data-target="prompt-input-short_description">
                                            ...
                                            <div class="card card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div
                                                            class="form-group col-md-6 mt-4 d-flex justify-content-between">
                                                            <label for="is_cod_allowed" class="col-form-label">Tax
                                                                included in prices?</label>
                                                            <a class=" form-switch  mr-1 mb-1" title="Deactivate"
                                                                href="javascript:void(0)"> <input type="checkbox"
                                                                    ...
                                                                    <?= (isset($product_details[0]['is_prices_inclusive_tax']) && $product_details[0]['is_prices_inclusive_tax'] == '1') ? 'checked' : '' ?> /></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12 <?= (isset($product_details[0]['video_type']) && ($product_details[0]['video_type'] == 'youtube' || $product_details[0]['video_type'] == 'vimeo')) ? '' : 'd-none'; ?>"
                                                                ...
                                                                <label for="video" class="col-form-label">Video Link
                                                            ...
                                                            <div class="col-md-12 <?= (isset($product_details[0]['video_type']) && ($product_details[0]['video_type'] == 'self_hosted')) ? '' : 'd-none'; ?>"
                                                                id="video_media_container">
                                                                <label for="image">Video <span
                                                                        class='text-danger text-sm'>*</span></label>
                                                                <div class='col-md-12 border refer_and_earn_border'><a
                                                                        class="" data-input='pro_input_video'
                                                                        data-isremovable='1' data-media_type="video"
                                                    ...
                                                    <div class="col-md-12 form-group mt-4">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            if (isset($product_details[0]['id']) && !empty($product_details[0]['id'])) {
                                                                ...
                                                                <div class="container-fluid row image-upload-section ">
                                                                    <div
                                                                        class="col-md-3 col-sm-12 shadow p-3 mb-5 bg-white rounded m-4 text-center grow image w-auto">
                                                                        <div class='image-upload-div'><img
                                                                                class="img-fluid mb-2"
                        ...
                        <div
                            class="col-md-12  mt-4 product_qty  <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                            <div class="row">
                                <div class=" mt-4 ">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="card card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6">
                                                            <div
                                                                class="indicator <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="indicator"
                                                                    class="col-form-label ">Indicator</label>
                                                                <select class='form-control' name='indicator'>
                                                                    <option value='0'
                                                                        <?= (isset($product_details[0]['indicator']) && $product_details[0]['indicator'] == '0') ? 'selected' : ''; ?>>None</option>
                                                                    <option value='1'
                                                                        <?= (isset($product_details[0]['indicator']) && $product_details[0]['indicator'] == '1') ? 'selected' : ''; ?>>Veg</option>
                                                                    <option value='2'
                                                                        <?= (isset($product_details[0]['indicator']) && $product_details[0]['indicator'] == '2') ? 'selected' : ''; ?>>Non-Veg</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 ">
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div
                                                                class="warranty_period <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="warranty_period"
                                                                    class="col-form-label">Warranty Period</label>
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div
                                                                class="guarantee_period <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="guarantee_period"
                                                                    class="col-form-label">Guarantee Period</label>
                                                                <input type="text" class="col-md-12 form-control"
                                                        ...
                                                        <div class="form-group col-md-6 ">
                                                            <div
                                                                class="bulk_discount_min_qty <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="bulk_discount_min_qty"
                                                                    class="col-form-label">Min Qty for Bulk
                                                                    Discount</label>
                                                                <input type="number" class="col-md-12 form-control"
                                                                    id="bulk_discount_min_qty"
                                                                    name="bulk_discount_min_qty" min="0"
                                                                    value="<?= (isset($product_details[0]['bulk_discount_min_qty'])) ? $product_details[0]['bulk_discount_min_qty'] : 0; ?>"
                                                                    placeholder="Min quantity for bulk discount">
                                                            </div>
                                                        </div>
                                                        <div class="form-group col-md-6 ">
                                                            <div
                                                                ...
                                                                <input type="number" class="col-md-12 form-control"
                                                                    ...
                                                                    value="<?= (isset($product_details[0]['bulk_discount_amount'])) ? $product_details[0]['bulk_discount_amount'] : 0; ?>"
                                                                    placeholder="Fixed discount amount for bulk orders">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div
                            class="col-md-12  mt-4 delivery_settings  <?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                            <div class="row">
                                <div class=" mt-4">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="card card-body">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="form-group col-md-6 ">
                                                            ...
                                                            <div
                                                                ...
                                                                if (isset($system_settings['city_wise_deliverability']) && $system_settings['city_wise_deliverability'] == 1 && $shipping_method['shiprocket_shipping_method'] != 1) { ?>
                                                                    <div class="row">
                                                                        <div class="form-group col-md-6">
                                                                            <label for="" class="col-form-label">Deliverable
                                                                                City Type</label>
                                                                            <select class="form-control"
                                                                        ...
                                                                        <div class="form-group col-md-6">
                                                                            ...
                                                                            <div class="mt-2">
                                                                                ...
                                                                                <select class="form-control city_list"
                                                                                    name="deliverable_cities[]"
                                                                                    id="deliverable_cities" multiple
                                                                                    <?= (isset($product_details[0]['deliverable_city_type']) && ($product_details[0]['deliverable_city_type'] == INCLUDED || $product_details[0]['deliverable_type'] == EXCLUDED)) ? "" : "disabled" ?>>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            <label for="shipping_type" class="col-form-label">For
                                                                standard shipping <span
                                                                    class='text-danger text-sm'>*</span></label>
                                                            <!-- drop down menu in while create product -->
                                                            <select class='form-control shiprocket_type'
                                                                ...
                                                                <?php foreach ($shipping_data as $row) {
                                                                    ...
                                                                    <option <?php if ($row['pickup_location'] == $pickup_location) { ?>
                                                                            selected <?php } ?>
                                                        ...
                                                        <div
                                                            class="form-group col-md-12 d-flex justify-content-between mt-4">
                                                            <div
                                                                class="col-md-4 cod_allowed d-flex justify-content-between mt-1<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="is_cod_allowed" class="col-form-label">Is
                                                                    COD allowed?</label>
                                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate"
                                                                    href="javascript:void(0)"> <input type="checkbox"
                                                                        class="form-check-input " role="switch"
                                                                        name="cod_allowed"
                                                                        <?= (isset($product_details[0]['cod_allowed']) && $product_details[0]['cod_allowed'] == '1') ? 'Checked' : '' ?> /></a>
                                                            </div>
                                                            <div
                                                                class="col-md-4  is_returnable d-flex justify-content-between<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="is_returnable" class="col-form-label">IS
                                                                    Returnable ?</label>
                                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate"
                                                                    href="javascript:void(0)"> <input type="checkbox"
                                                                        class="form-check-input " role="switch"
                                                                        name="is_returnable"
                                                                        <?= (isset($product_details[0]['is_returnable']) && $product_details[0]['is_returnable'] == '1') ? 'Checked' : '' ?> /></a>
                                                            </div>
                                                        </div>
                                                        <div
                                                            class="form-group col-md-12 d-flex justify-content-between  mt-4">
                                                            <div
                                                                class="col-md-4 is_cancelable  d-flex justify-content-between<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="is_cancelable" class="col-form-label">Is
                                                                    cancelable ? </label>
                                                                <a class="form-switch  mr-1 mb-1" title="Deactivate"
                                                                    href="javascript:void(0)"> <input type="checkbox"
                                                                        class="form-check-input" role="switch"
                                                                        id="is_cancelable" name="is_cancelable"
                                                                        <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == '1') ? 'Checked' : '' ?> /></a>
                                                            </div>
                                                            <div
                                                                class="col-md-4  is_attachment_required d-flex justify-content-between<?= (isset($product_details[0]['type']) && $product_details[0]['type'] == 'digital_product') ? 'd-none' : '' ?>">
                                                                <label for="is_attachment_required"
                                                                    class="col-form-label is_attachment_required">Is
                                                                    Attachment Required ?</label>
                                                                <a class=" form-switch  mr-1 mb-1" title="Deactivate"
                                                                    href="javascript:void(0)"> <input type="checkbox"
                                                                        class="form-check-input " role="switch"
                                                                        name="is_attachment_required"
                                                                        <?= (isset($product_details[0]['is_attachment_required']) && $product_details[0]['is_attachment_required'] == '1') ? 'Checked' : '' ?> /></a>
                                                            </div>
                                                        </div>

                                                        <div
                                                            class="form-group col-md-8 d-flex justify-content-between  mt-4">
                                                            <div class="col-md-6 col-xs-6 <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == 1) ? '' : 'collapse' ?>"
                                                                id='cancelable_till'>
                                                                <label for="cancelable_till" class="col-form-label">Till
                                                                    which status ? <span
                                                                        class='text-danger text-sm'>*</span></label>
                                                        ...
                                                        if (isset($product_details)) {
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="row mt-4 col-md-12 ">
                                                                    <nav class="w-100">
                                                                        <div class="nav nav-tabs product-variations"
                                                                            id="product-tab" role="tablist">
                                                                            <a class="nav-item nav-link active w-auto"
                                                                                id="tab-for-general-price" data-toggle="tab"
                                                                                href="#general-settings" role="tab"
                                                                                aria-controls="general-price"
                                                                                aria-selected="true">General</a>
                                                                            <a class="nav-item nav-link edit-product-attributes w-auto"
                                                                ...
                                                                <div class="tab-content p-3 col-md-12" id="nav-tabContent">
                                                                    <div class="tab-pane fade active show"
                                                                        id="general-settings" role="tabpanel"
                                                                        aria-labelledby="general-settings-tab">
                                                                        <div class="form-group">
                                                                            <label for="type" class="col-md-12">Type Of
                                                                                Product :<span
                                                                        ...
                                                                        <div id='product-general-settings'>
                                                                            ...
                                                                            if ($product_details[0]['type'] == "simple_product" || $product_details[0]['type'] == "digital_product") {
                                                                                ...
                                                                                <div id="general_price_section">
                                                                                    ...
                                                                                    <div
                                                                                        class="form-group row mt-2 dimensions  
                                                                                        ...
                                                                                        <div class="col-3">
                                                                                            ...
                                                                                            <input type="number"
                                                                                                ...
                                                                                                value="<?= (isset($product_variants[0]['weight']) && !empty($product_variants[0]['weight'])) ? $product_variants[0]['weight'] : "" ?>"
                                                                                                step="0.01">
                                                                                        </div>
                                                                                        <div class="col-3">
                                                                                            <label for="height"
                                                                                            ...
                                                                                            <input type="number"
                                                                                                ...
                                                                                                value="<?= (isset($product_variants[0]['height']) && !empty($product_variants[0]['height'])) ? $product_variants[0]['height'] : "" ?>">
                                                                                        </div>
                                                                                        <div class="col-3">
                                                                                            <label for="breadth"
                                                                                            ...
                                                                                            <input type="number"
                                                                                                ...
                                                                                                placeholder="Breadth"
                                                                                                id="breadth"
                                                                                                value="<?= (isset($product_variants[0]['breadth']) && !empty($product_variants[0]['breadth'])) ? $product_variants[0]['breadth'] : "" ?>">
                                                                                        </div>
                                                                                        <div class="col-3">
                                                                                            <label for="length"
                                                                                            ...
                                                                                            <input type="number"
                                                                                                ...
                                                                                                value="<?= (isset($product_variants[0]['length']) && !empty($product_variants[0]['length'])) ? $product_variants[0]['length'] : "" ?>">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div
                                                                                        ...
                                                                                        <div class="col mt-3">
                                                                                            ...
                                                                                            <span class="align-middle">Enable
                                                                                        ...
                                                                                        <select type="text"
                                                                                            ...
                                                                                            <option value="1"
                                                                                                <?= (isset($product_details[0]['stock_type']) &&
                                                                                                    $product_details[0]['stock_type'] != NULL && $product_details[0]['availability'] == "1") ? 'selected' : '' ?>>In Stock
                                                                                            </option>
                                                                                            <option value="0"
                                                                                                <?= (isset($product_details[0]['stock_type']) &&
                                                                                                    $product_details[0]['stock_type'] != NULL && $product_details[0]['availability'] == "0") ? 'selected' : '' ?>>Out Of
                                                                                                Stock</option>
                                                                                        </select>
                                                                                    </div>
                                                                                </div>
                                                                                        ...
                                                                                        <div class="row form-group">
                                                                                            <div class="col-md-2 col-xs-6 ml-2">
                                                                                                <label for="is_cod_allowed"
                                                                                                    class="col-form-label">Is
                                                                                                    Download allowed?</label>
                                                                                                <input type="checkbox"
                                                                                            ...
                                                                                            <div class="col-md-6 mt-2 <?= (isset($product_details[0]['download_type']) && ($product_details[0]['download_type'] == 'self_hosted')) ? '' : 'd-none'; ?>"
                                                                                                ...
                                                                                                <label for="image" class="ml-2">File
                                                                                                    <span
                                                                                                        class='text-danger text-sm'>*</span></label>
                                                                                    ...
                                                                                    <div class="form-group <?= (intval($product_details[0]['stock_type']) > 0) ? '' : 'collapse' ?>"
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div class="col col-xs-12">
                                                                                                    <label
                                                                                                        class="control-label mt-2">SKU
                                                                                                        :</label>
                                                                                                    <input type="text"
                                                                                                        name="sku_variant_type"
                                                                                                        class="col form-control mt-2"
                                                                                                ...
                                                                                                <div class="col col-xs-12">
                                                                                                    <label
                                                                                                        class="control-label mt-2">Total
                                                                                                        Stock :</label>
                                                                                                    <input type="number" min="1"
                                                                                                        name="total_stock_variant_type"
                                                                                                        class="col form-control variant-stock-mustfill-field mt-2"
                                                                                                ...
                                                                                                <div class="col col-xs-12">
                                                                                                    ...
                                                                                                    <select type="text"
                                                                                                        ...
                                                                                                        class="col form-control variant-stock-mustfill-field mt-2">
                                                                                                        <option value="1"
                                                                                                            <?= (intval($product_details[0]['stock_type']) == 1 && isset($product_variants[0]['id']) && $product_variants[0]['availability'] == '1') ? 'Selected' : '' ?>>In Stock</option>
                                                                                                        <option value="0"
                                                                    ...
                                                                    <div class="tab-pane fade" id="product-attributes"
                                                                        ...
                                                                        <div class="info col-12 p-3 d-none" id="note">
                                                                            <div class=" col-12 d-flex align-center gap-4">
                                                                                <div>
                                                                                    <strong>Note : </strong>
                                                                                    <span class="ml-3">check if the
                                                                                        attribute is to be used for
                                                                                        variation </span>
                                                                                </div>
                                                            ...
                                                            ?>
                                                                    <div
                                                                        ...
                                                                        <div class="row mt-4 col-md-12 ">
                                                                            <nav class="w-100">
                                                                                <div class="nav nav-tabs product-variations"
                                                                                    ...
                                                                                    <a class="nav-item nav-link active w-auto"
                                                                                        ...
                                                                                        aria-controls="general-price"
                                                                                        aria-selected="true">General</a>
                                                                                    <a class="nav-item nav-link disabled product-attributes w-auto"
                                                                                        id="tab-for-attributes"
                                                                                        data-toggle="tab"
                                                                            ...
                                                                            <div class="tab-content p-3 col-md-12"
                                                                                id="nav-tabContent">
                                                                                <div class="tab-pane fade active show"
                                                                                    id="general-settings" role="tabpanel"
                                                                                    aria-labelledby="general-settings-tab">
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                ...
                                                                                                <div class="col-md-12 mt-2">
                                                                                                    <input id="base_price"
                                                                                                        type="number"
                                                                                                        name="simple_price"
                                                                                                        class="form-control stock-simple-mustfill-field price base-price"
                                                                                                        min='1' step="0.01">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="form-group">
                                                                                        ...
                                                                                        <div class="form-group collapse"
                                                                                            ...
                                                                                            <div class="col-md-12">
                                                                                                <select
                                                                                                    ...
                                                                                                    <option
                                                                                                        value="variable_level">
                                                                                                        Variable Level (
                                                                                                        Stock Will Be
                                                                                                        Managed Variant Wise
                                                                                                        )</option>
                                                                                                </select>
                                                                                                <div
                                                                                ...
                                                                                <div class="tab-pane fade"
                                                                                    id="product-attributes" role="tabpanel"
                                                                                    aria-labelledby="product-attributes-tab">
                                                                                    <div class="info col-12 p-3 d-none"
                                                                                        id="note">
                                                                                        <div
                                                                                ...
                                                                                <div class="tab-pane fade"
                                                                                    id="product-variants" role="tabpanel"
                                                                                    aria-labelledby="product-variants-tab">
                                                                                    <div class="col-md-12">
                                                                                        <a href="javascript:void(0);"
                                                                                            id="reset_variants"
                                                ...
                                                <div class="card card-body">
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-primary ms-2 generate-ai-btn"
                                                                data-field="pro_input_description" title="Generate with AI">
                                                                <i class="bi bi-magic"></i> AI
                                                            </button>

                                                            <button type="button"
                                                                class="btn btn-sm btn-outline-primary ms-1 toggle-custom-prompt-btn"
                                                                data-target="custom-prompt-pro_input_description"
                                                                title="Custom Prompt">
                                                                <ion-icon name="create-outline"
                                                                    class="text-primary"></ion-icon>
                                                            </button>
                                                    ...
                                                    <!-- Custom Prompt Box -->
                                                    <div id="custom-prompt-pro_input_description" class="mb-2 d-none">
                                                        <div class="input-group">
                                                            <input type="text" class="form-control"
                                                                id="prompt-input-pro_input_description"
                                                                placeholder="Enter custom instructions for AI...">

                                                            <button type="button"
                                                                class="btn btn-outline-secondary suggest-prompts-btn"
                                                                data-field="pro_input_description"
                                                                title="Get Suggested Prompts">
                                                                <ion-icon name="bulb-outline"
                                                                    class="text-secondary"></ion-icon>
                                                            </button>
                                                        ...
                                                        <select class="form-select mt-1 d-none prompt-suggestions"
                                                            id="suggestions-pro_input_description"
                                                            data-target="prompt-input-pro_input_description">
                                                            <option value="">Select a suggested prompt...</option>
                                                        </select>
                                                    </div>
