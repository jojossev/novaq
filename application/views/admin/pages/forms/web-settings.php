                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input type="number" class="form-control mb-2" min="0" name="support_number" value="<?= (isset($web_settings['support_number'])) ? output_escaping($web_settings['support_number']) : '' ?>" placeholder="Customer support mobile number" />
                                    </div>
                                    <div class="form-group col-md-4">
                                ...
                                <h4 class="h4 col-md-12">Classic Theme Settings</h4>
                                ...
                                <div class="form-group mt-4">
                                    ...
                                    <button type="submit" class="btn btn-success update_setting" id="submit_btn">Update Settings</button>
                                </div>
