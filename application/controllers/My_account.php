    ...
    public function add_address()
    {
        if ($this->ion_auth->logged_in()) {
            ...
            if (isset($_POST['pincode']) && !empty($_POST['pincode'])) {
                ...
                $this->form_validation->set_rules('pincode_name', 'Pincode', 'trim|required|xss_clean');
            }
            ...
            $this->form_validation->set_rules('general_area_name', 'general area name', 'trim|xss_clean|required');
