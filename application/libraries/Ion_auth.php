...
class Ion_auth
{
    ...
    function get_email_settings()
    {
        ...
        if ($numRows > 0) {
            ...
            if (!empty($email_settings)) {
                ...
                // Save the configuration to CI config
        ...
        return $email_settings; // Return null or email settings if available
    }
    ...
    {
        $email_config = $this->get_email_settings(); 
        ...
        if ($user) {
            ...
            if ($code) {
                ...
                if (!$this->config->item('use_ci_email', 'ion_auth')) {
                    ...
                    $this->email->clear();
                    $this->email->from($email_config['smtp_user'], $this->config->item('site_title', 'ion_auth'));
