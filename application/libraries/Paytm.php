...
class Paytm
{
    ...
    static public function get_credentials()
    {
        ...
        $data['url'] = ($settings['paytm_payment_mode'] == "production") ? "https://secure.paytmpayments.com/" : "https://securestage.paytmpayments.com/";
        // Use configured website name from settings, with fallback to WEBSTAGING
        $data['paytm_website'] = (isset($settings['paytm_website']) && !empty($settings['paytm_website'])) ? $settings['paytm_website'] : "WEBSTAGING";
        $data['paytm_industry_type_id'] = (isset($settings['paytm_industry_type_id']) && !empty($settings['paytm_industry_type_id'])) ? $settings['paytm_industry_type_id'] : "Retail";
        return $data;
    }
