        ...
        if (chat.position == 'chat-right') {
            ...
            if (!!chat.media_files) {
                ...
                $.each(chat.media_files, function (key, val) {
                    ...
                    if (val['file_extension'] == 'image/jpg' || val['file_extension'] == 'image/png' || val['file_extension'] == 'image/jpeg' || val['file_extension'] == 'image/webp' || val['file_extension'] == '.png' || val['file_extension'] == '.jpg' || val['file_extension'] == '.jpeg') {
            ...
            if (!!chat.media_files) {
                $.each(chat.media_files, function (key, val) {
                    if (val['file_extension'] == 'image/jpg' || val['file_extension'] == 'image/png' || val['file_extension'] == 'image/jpeg' || val['file_extension'] == 'image/webp' || val['file_extension'] == '.png' || val['file_extension'] == '.jpg' || val['file_extension'] == '.jpeg') {
                        ...
                        media_files += '<span class="chat-files" style="position: relative;"><a href="' + base_url + 'uploads/chat_media/' + val['original_file_name'] + '" download="' + val['original_file_name'] + '" class="download-btn-styling download-msg fas fa-download"></a><div class="chat_media_img"><i class="fas fa-file-alt text-primary"></i></div><div class="chat_media_file">' + val['original_file_name'] + '</div><div class="chat_media_size">' + val['file_size'] + '</div></span>';
                    }
                });
            }
        }
