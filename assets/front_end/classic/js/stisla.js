...
(function ($, window, i) {
    ...
    $.chatCtrl = function (element, chat, direction = 'top') {
        ...
        var person_group_chat = '';        var target = $(element),
            element = chat_divider_html + '<div class="chat-item ' + vis + ' ' + chat.position + '" data-delete_msg_id="' + chat.msg_id + '">' +
                ...
                '<div class="chat-text" ><span class="msg_text_media" style="word-wrap: break-word; word-break: break-word; white-space: pre-wrap; max-width: 100%; display: inline-block;">' + person_group_chat + ' ' + chat.text + ' ' + media_files + '</span></div>' +
