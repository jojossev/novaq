...
function cssBundle() {
    return src([
        ...
        'assets/front_end/classic/css/jquery.jssocials-theme-flat.css',
        'assets/front_end/classic/css/jquery.jssocials.css',
        'assets/front_end/classic/css/dropzone.css',
    ])
...
const jsBundle = () =>
    src([
        ...
        'assets/front_end/classic/js/jquery.validate.min.js',
        'assets/front_end/classic/js/dropzone.js',
        'assets/front_end/classic/js/Markdown.Converter.js',
        'assets/front_end/classic/js/Markdown.Sanitizer.js',
        'assets/front_end/classic/js/Markdown.Editor.js',
        'assets/front_end/classic/js/dropzone.min.js',
        'assets/front_end/classic/js/stisla.js',
        'assets/front_end/classic/js/custom.js',
        'assets/front_end/classic/js/deeplink.js',
